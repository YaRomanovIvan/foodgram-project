...
class Recipe(models.Model):
    ...
    ingredient=models.ManyToManyField(
        Ingredient, through='RecipeIngredient', related_name='ingredient', verbose_name='Используемые ингредиеты',
    )
    tags = models.ManyToManyField(Tag, through='RecipeTag', related_name='tags', verbose_name='Теги',)
